...
function headerMenu() {
    ...
    menu.addEventListener("click", (event) => {
        ...
        if (target.classList.contains("js-toggle-sub-menu") &&
            ...
            // collapse the other expanded munu-item if exists
...
function themeGlassEffect() {
    const galssEffectCheckbox = document.querySelector(".js-glass-effect"),
        glassStyle = document.querySelector(".js-glass-style");

    galssEffectCheckbox.addEventListener("click", function () {
        if (this.checked) {
    ...
    if (!glassStyle.hasAttribute("disabled")) {
        galssEffectCheckbox.checked = "true";
    }
}
themeGlassEffect();